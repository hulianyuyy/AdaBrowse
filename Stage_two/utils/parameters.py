...
def get_parser():
    ...
    parser.add_argument(
        '--conv2d_small_weight_path',
        default='.',
        help='path to the weight of conv2d_small') 
    parser.add_argument(
        '--conv2d_mid_weight_path',
        default='.',
        help='path to the weight of conv2d_mid') 
    parser.add_argument(
        '--conv2d_big_weight_path',
        default='.',
        help='path to the weight of conv2d_big')
    parser.add_argument(
        '--random_fix',
        type=str2bool,
        default=True,
    ...
    parser.add_argument(
        ...
        type=str2bool,
        default=False,
        help='decide whether to use separate mode in eval')
    parser.add_argument(
        '--python_evaluate',
        type=str2bool,
        default=False,
        help='decide whether to use python_evaluate in eval')    
    parser.add_argument(
        '--device',
        type=str,
        default=0,
